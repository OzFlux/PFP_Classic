...
# ============================================================================
# This python program was modified from the original to read data from a L1 
# netcdf file with all sites as individual variables. Data were downloaded 
...
for site in site_list:
    ...
    modis_dt_interp = [result for result in pfp_utils.perdelta(start_date,end_date,tdts)]
    ...
    dt_UTC = [result for result in pfp_utils.perdelta(start_date,end_date,tdts)]
    ...
    pfp_utils.CreateSeries(ds,"EVI",evi_interp2_smooth,flag,attr)
    ...
    attr = pfp_utils.MakeAttributeDictionary(long_name="MODIS EVI, interpolated",units="none",
                                           ...
                                           evi_sd_threshold=str(evi_sd_threshold),
                                           evi_interpolate=str(evi_interpolate))
    pfp_utils.CreateSeries(ds,"EVI_notsmoothed",evi_interp2,flag,attr)
