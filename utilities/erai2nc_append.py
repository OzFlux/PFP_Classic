...
# CME: sys.path.append('../../../PyFluxPro/scripts/')
# PFP
...
def read_site_master(xl_file_path, sheet_name):
    ...
    site_master.xls can have more than one sheet. In erai2nc.txt the sheetname is specified.
    """
...
# CME: cf = pfp_io.load_controlfile(path='../../../Controlfiles')
...
if out_process == 'append':
   erai_files = erai_list[-1:]
else:
   erai_files = erai_list

print 'CE: erai_files = ',erai_files
...
for site_name in site_list:
    ...
    # Add sites' ERAI datafile to the list of files to be concatenated
    # Check out_file_path for existing file <site>_ERAI.nc
    add_exist = 0
    if os.path.isfile(out_file_path):
        # rename existing file and set code to append new processed data
        this_day = datetime.datetime.today().strftime('%Y%m%d')
        this_day_file_path = os.path.join(out_base_path,site_name,"Data","ERAI",this_day+site_name+"_ERAI.nc")
        print 'CE:',this_day_file_path
        os.rename(out_file_path,this_day_file_path)
        if out_process == 'append':
           cf_dict[site_name]["Files"]["In"][str(0)] = this_day_file_path
           add_exist = 1

for n, erai_name in enumerate(erai_files):
    ...
    for site_name in site_list:
        ...
        start_date = pfp_utils.rounddttots(dt_erai_utc_cor[0],ts=site_timestep)
        if start_date<dt_erai_utc_cor[0]: start_date = start_date+tdts
        end_date = pfp_utils.rounddttots(dt_erai_utc_cor[-1],ts=site_timestep)
        ...
        logger.info(msg)
        print 'CE: start and end closest to dt = ',msg
        #print site_name,end_date,dt_erai_utc_cor[-1]
        # UTC datetime series at the tower time step
        dt_erai_utc_tts = [x for x in pfp_utils.perdelta(start_date,end_date,tdts)]
        ...
        pfp_utils.get_xldatefromdatetime(ds_erai)
        # get the year, month, day, hour, minute and second
        pfp_utils.get_ymdhmsfromdatetime(ds_erai)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fsd",Fsd_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fn_sw",Fn_sw_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fsu",Fsu_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fld",Fld_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fn_lw",Fn_lw_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Flu",Flu_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fn",Fn_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fh",Fh_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fe",Fe_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fg",Fg_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Fa",Fa_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"ps",ps_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Ta",Ta_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"VPD",VPD_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"RH",RH_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Ah",Ah_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"q",q_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Habl",Habl_erai_tts,flag,attr)
        ...
        idx = pfp_utils.FindIndicesOfBInA(dt_erai_utc_cor,dt_erai_utc_tts)
        ...
        pfp_utils.CreateSeries(ds_erai,"Precip",Precip_erai_tts,flag,attr)
        ...
        attr = pfp_utils.MakeAttributeDictionary(long_name="Soil moisture",units="frac")
        pfp_utils.CreateSeries(ds_erai,"Sws",Sws_erai_tts,flag,attr)
        ...
        attr = pfp_utils.MakeAttributeDictionary(long_name="Soil temperature",units="C")
        pfp_utils.CreateSeries(ds_erai,"Ts",Ts_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"U",U_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"V",V_erai_tts,flag,attr)
        ...
        pfp_utils.CreateSeries(ds_erai,"Ws",Ws_erai_tts,flag,attr)
...
for site_name in site_list:
    ...
    cf_concat.write()
    msg = "Concatenating files for "+site_name
    logger.info(msg)
